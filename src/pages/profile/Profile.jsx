        ...
        <div className="forHeaderFix forBottomFix">
            ...
            <div className="profileTop">
                ...
                <div className="profileTop_right">
                    <h3>Manik Mitra</h3>
                    <p>Saltlake, sectoe II, Kolkata - 7001234</p>
                </div>
            </div>

            <div className="profileContact">
                <ul>
                    <li><i className="far fa-phone-alt"></i> 9876543210</li>
                    <li><i className="far fa-envelope"></i> abcd12345@email.com</li>
                </ul>
            </div>

            <div className="profileWalletOrder">
                <div className="profileWallet">
                    <h3><i className="far fa-rupee-sign"></i> 1149.00</h3>
                    <span>Wallet</span>
                </div>
            ...
            <div className="profileLinks">
                <Paper className="profileLink_box" sx={{ width: "100%", maxWidth: '100%' }}>
                    <MenuList>
                        <MenuItem>
                            <Link to="/deliveryaddress">
                                ...
                                <ListItemText className='profileMenuText'>Address</ListItemText>
                            </Link>
                        </MenuItem>
                        <MenuItem>
                            {['bottom'].map((bottom) => (
                                ...
                                <Link to="/" onClick={toggleDrawer(bottom, true)} >
                                    ...
                                    <ListItemText className='profileMenuText'>Referral</ListItemText>
                                </Link>
                                </>
                            ))}
                        ...
                        <MenuItem>
                            <Link to="/profile">
                                ...
                                <ListItemText className='profileMenuText'>Contact Us</ListItemText>
                            </Link>
                        </MenuItem>
                        ...
                        <MenuItem>
                            <Link to="/">
                                ...
                                <ListItemText className='profileMenuText'>Logout</ListItemText>
                            </Link>
                        </MenuItem>
                    </MenuList>
                </Paper>
            ...
            <React.Fragment key={bottom}>
                ...
                >
                    ...
                    <div className='referText'>
                        ...
                        <p>Copy or directly share on social media or email to their family & friends.</p>
                    </div>
                    <div className='referCode'>
                        <h6>Your Referral Code</h6>
                        <div className="referCode__box">
                            <div className="referCode__box__left">
                            WZI503
                            </div>
